...
transition\_*() defines how the data should be spread out and how it relates to itself across time. view\_*() defines how the positional scales should change along the animation. shadow\_*() defines how data from other points in time should be presented in the given point in time. enter\_*()/exit\_\*() defines how new data should appear and how old data should disappear during the course of the animation. ease_aes() defines how different aesthetics should be eased during transitions.
